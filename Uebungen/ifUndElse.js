...
let a1 = 2 // Eine Variable (z.B. a1 oder zahl1) wird mit dem Wert 1 initialisiert
let b1 = 2 // Eine Variable (z.B. b1 oder zahl1) wird mit dem Wert 2 initialisiert
...
// Erkenntnisgewinn: Mit dem einfachen Gleichheitszeichen wird ein Wert von rechtsnach
// links zugewiesen. Mit dem doppelten Gleicheitszeichen werden zwei Werte auf 
// Wert-Gleicheit geprüft. MIt dem dreifachen Glkeichheitszeichen werden zwei Werte
// auf Wert- und Typ-Gleicheit überprüft.

console.log("Übung 3 - Prüfung auf Wert- (und Typ-) Gleicheit:")
...
console.log("Übung 4 - Prüfung auf Wert- (und Typ-) Gleicheit:")
...
if(lebensmittel){
    ...
    console.log("Mehrwertsteuersatzt: 19%")
}
...
if(true){
    console.log("Diese Prüfung ist immer true")
}

console.log("Übung 8 - Prüfung von Zahlen:")
...
if (einzahlung-auszahlung){
    ...
    console.log("Der Salso ist null")
}